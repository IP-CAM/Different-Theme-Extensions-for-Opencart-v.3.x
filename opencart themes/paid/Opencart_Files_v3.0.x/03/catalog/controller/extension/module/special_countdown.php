...
class ControllerExtensionModuleSpecialCountdown extends Controller {
	public function index($setting) {
		...
		$this->document->addScript('catalog/view/javascript/mahardhi/countdown.js');
		...
		if ($results) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_theme') . '/template/extension/module/special_countdown.twig')) {
