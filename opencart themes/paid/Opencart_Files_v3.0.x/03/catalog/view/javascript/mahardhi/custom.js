(function ($) {
	...
	function responsiveheader(){
		if ($(window).width() <= 991) {	
			...
			$('.category-list').insertAfter('#menu #topCategoryList > ul');
			...
			$('.category-list').appendTo('.vertical-category');
	...
	$(function(){
		...
		if ( menu.length > max_elem ) {
			$('ul.category-list').append('<li class="more"><a class="more-menu"><span class="categories">More Categories</span></a></li>');
		}
		...
		$('ul.category-list > li .more-menu').click(function() {
			if ($(this).hasClass('active')) {
				...
				$('.more-menu').html('<span class="categories">More Categories</span>');
			} else {
				menu.each(function(j) {
					if ( j >= max_elem  ) {
						$(this).slideDown(200);
				...
				$(this).addClass('active');
				$('.more-menu').html('<span class="categories">Less Categories</span>');
			}
		});
